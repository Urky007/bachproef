...
\projectrepo{https://github.com/Urky007/bachproef}
...
Eerst werd er een literatuurstudie uitgevoerd om  een accuraad beeld te schetsen over de huidige stand van zaken omtrend PAM. Hierbij werd gebruik gemaakt van toonaangevende studies zoals Gartner en KuppingerCole.
\begin{center}
	\captionsetup{type=figure}
	\includegraphics[width=0.4\linewidth]{MagicQuadrant.png}
	\captionof{figure}{De Gartner Magic Quadrant.}
\end{center}

Daarna werd een vergelijkende studie uitgevoerd van vier PAM-oplossingen:
\begin{itemize}
	\item CyberArk
	\item BeyondTrust
...
Ten slotte werd een proof-of-concept opgezet waarbij PAM360 en Securden werden geïmplementeerd in een gecontroleerde testomgeving. Hiervoor werd een gesegmenteerd netwerk ingericht met Windows- en Linux-servers, Active Directory en een Fortinet-firewall.

\begin{center}
	\captionsetup{type=figure}
	\includegraphics[width=0.55\linewidth]{Architectuurschema.png}
	\captionof{figure}{Architectuuroverzicht van de proof-of-concept omgeving.}
\end{center}
